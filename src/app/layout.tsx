  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="forward-personal-training";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Forward Personal Training & Health Solutions"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="forward-personal-training"
          data-primary-color="#796758"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="forward-personal-training";
